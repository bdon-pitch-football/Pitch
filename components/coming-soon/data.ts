...
// FAQ (drafted 3 Sep on BUZ's request) — honest-promises discipline (D-53):
// no dates, no "potential", never "social network" as a self-description,
// under-18 promise restated since the pricing banner was hidden.
